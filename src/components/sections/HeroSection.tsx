...
const HeroSection = () => {
  ...
  return (
    <section
      id='hero'
      ref={ref}
      className='text-white/80 relative flex flex-col justify-center h-screen snap-start bg-[url("https://i.pinimg.com/736x/a5/20/4c/a5204cb54edafeaed19d93acfce7cc74.jpg")] bg-no-repeat bg-center bg-cover'>
      <div className='p-12'>
        <h1
