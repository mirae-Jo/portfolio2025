  ...
  return (
    <>
      ...
      <div
        ...
        <div className='bg-white/10 backdrop-blur-sm border-b border-white p-2 flex items-center justify-between rounded-b-lg shadow-lg'>
          ...
          <div
            ...
            className='w-1 h-1 overflow-hidden absolute left-[-9999px] opacity-0'></div>

          <button
            onClick={togglePlay}
            className='p-2 text-white bg-white/20 rounded-full hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all duration-200 transform hover:scale-110 hover:cursor-pointer'>
            {isPlaying ? (
              <svg
          ...
          <button
            ...
            className='ml-2 p-1 text-white bg-white/20 rounded-full hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all duration-200 transform hover:scale-110 hover:cursor-pointer'>
            {isExpanded ? (
              <svg
                xmlns='http://www.w3.org/2000/svg'
                className='h-4 w-4'
      ...
      {!isExpanded && hasBeenCollapsedOnce && (
        <div
          className='fixed top-0 left-1/2 -translate-x-1/2 mt-2 p-1.5 bg-white/10 backdrop-blur-sm border border-white rounded-full shadow-lg cursor-pointer z-[999]'
